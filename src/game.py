...
class Game:
    ...
    def __init__(self, player_one: Player, player_two: Player):
        ...
        self._board_state =          0b10000000000000001000000000000000
    ...
    def game_state(self) -> bytes:
        return self._board_state & self._game_state_mask
    ...
    def player(self, player_num: int):
        ...
        self._board_state ^= (player_num << self.player_bitlen)
...
if __name__ == "__main__":
    ...
    board_test._board_state = 0b11000000000000111000000001011100
